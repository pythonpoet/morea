...
enum AuthProblems { userNotFound, passwordNotValid, networkError, undefinedError}
abstract class BaseAuth{
  ...
  Future<void> signOut();
  AuthProblems checkForAuthErrors(BuildContext context, PlatformException error);
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  child: Center(
                    child: Text(errorMessage, style: TextStyle(fontSize: 25)),
                  ),
                ),
                new Divider(),
                Container(
