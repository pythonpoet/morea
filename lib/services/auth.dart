...
class Auth implements BaseAuth {
  ...
  Future uebunganmelden(Map anmeldedaten, String stufe, String _userUID) async {
    ...
    Firestore.instance
        .collection('uebung')
        .document(stufe)
        .collection(uebungsdatum)
        .document(_userUID)
        .setData(anmeldedaten)
        .catchError((e) {
      print(e);
    });
  }
  ...
  Future uploadteleblitz(data, stufe) async {
    ...
    Firestore.instance
        .collection('Teleblitz')
        .document('overview')
        .collection(stufe)
        .document(akteleblitz['AktuellerTeleblitz'])
        .setData(data)
        .catchError((e) {
      print(e);
    });
  ...
  Future<DocumentSnapshot> getteleblitz(stufe) async {
    if (stufe != null) {
      stufe = formatstring(stufe);
      DocumentSnapshot aktdat = await Firestore.instance
          .collection('Teleblitz')
          .document('info')
          .collection(stufe)
          .document('AktuellerTeleblitz')
      ...
      return await Firestore.instance
          ...
          .document('overview')
          .collection(stufe)
          .document((aktdat.data['AktuellerTeleblitz']).toString())
          .get();
    }
  }
  ...
  Future<bool> refreshteleblitz(stufe) async {
    ...
    DocumentSnapshot aktdat = await Firestore.instance
        ...
        .document('info')
        .collection(stufe)
        .document('Teleblitzaktualisiert')
        .get();
