...
Future<Widget> makeLeiterWidget(BuildContext context, String userID, String groupID){
  ...
  return scanDialog(context, [
    Text(
        ...
        Text('Scanne den Qr-Code eines Teilnehmers um ihn zum Leiter machen. ', style: TextStyle(fontSize: 20),),
        SizedBox(
          height: 30,
        ),
        StreamBuilder(
          ...
          builder: (BuildContext context,  asFunction){
              ...
              return Column(
                   ...
                   stream.add(666),
                    if (qrCode.germanError ==
                      'Um den Kopplungsvorgang mit deinem Kind abzuschliessen, scanne den Qr-Code, der im Profil deines Kindes ersichtlich ist.') {
                        makeLeiter(userID, qrCode.qrResult, groupID).then((onValue){
                ...
                textColor: Colors.white,
                 ...
                 new RaisedButton(
                    ...
                    onPressed: () async => {stream.close(), Navigator.of(context).pop()},
                    shape: new RoundedRectangleBorder(
                        borderRadius: new BorderRadius.circular(30.0)),
                    color: Color(0xff7a62ff),
                    textColor: Colors.white,
            ...
            if(!asFunction.hasData)
              return Container(child: simpleMoreaLoadingIndicator(),width: 100,);
            if(asFunction.data is int)
              ...
              return Column(
                ...
                children: <Widget>[
                  ...
                  Text("Hinzugefügt", style: TextStyle(fontSize: 20),),
                  SizedBox(height: 200,),
                  new RaisedButton(
                    child: new Text('Abbrechen',
                        style: new TextStyle(fontSize: 20)),
